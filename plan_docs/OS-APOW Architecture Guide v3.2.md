...
* **Environment:** A high-fidelity DevContainer built from the workflow-orchestration-queue-mike26.  
* **Worker Capabilities:**  
...
1. **Bootstrap:** The developer manually clones the workflow-orchestration-queue-mike26.  
