...
**Locations to update:**
- The orchestrator prompt template in `workflow-orchestration-queue-mike26` (e.g., `prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | workflow-orchestration-queue-mike26 | Define 4-step loop |
